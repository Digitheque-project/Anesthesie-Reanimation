...
export class ReceiveDemandeCpaDto {
  @ApiProperty({
    description:
      'Identifiant du patient (identique à celui utilisé par le service Accueil).',
  ...
  @ApiProperty({
    description:
      "Identifiant du service demandeur (tel qu'enregistré dans le registre central des services).",
  ...
  @ApiProperty({
    description:
      'Type de référence métier côté service demandeur (ex: "examen", "consultation").',
    example: 'examen',
  })
  @IsString()
  ...
  @ApiProperty({
    description:
      'Identifiant de cette référence côté service demandeur — renvoyé tel quel dans le callback de résultat pour corrélation.',
  ...
  @ApiPropertyOptional({
    description:
      "Date souhaitée pour l'examen/acte (indicative pour la planification CPA).",
    example: '2026-08-01',
  })
  @IsOptional()
  @IsDateString()

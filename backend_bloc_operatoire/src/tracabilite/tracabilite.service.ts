...
export class TracabiliteService {
  constructor(@InjectRepository(HistoriqueModification) private repo: Repository<HistoriqueModification>) {}

  async log(entite: string, entiteId: string, action: string, details?: any, utilisateurId?: string) {

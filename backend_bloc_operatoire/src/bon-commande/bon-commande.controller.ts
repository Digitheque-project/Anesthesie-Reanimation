...
export class BonCommandeController {
  ...
  create(@Body() dto: CreateBonCommandeDto) { return this.service.create(dto); }
  ...
  update(@Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateBonCommandeDto) { return this.service.update(id, dto); }

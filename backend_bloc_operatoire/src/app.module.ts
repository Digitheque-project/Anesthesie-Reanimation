...
@Module({
  imports: [
    ...
    ActivitePerOpModule, ProtocoleOperatoireModule,
    ScoreSCCREModule, SortieReveilModule, NotificationCPAModule,
    AuthModule, ArchivesModule, RapportsModule, PlanningModule,
    TracabiliteModule, ExportsModule,
    ChecklistAvantOpModule, ChecklistPendantOpModule, ChecklistApresOpModule,
  ],

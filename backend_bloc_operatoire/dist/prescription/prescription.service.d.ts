...
export declare class PrescriptionService {
    ...
    private polling;
    constructor(patientBlocRepo: Repository<PatientBloc>, notificationRepo: Repository<NotificationCPA>, creneauRepo: Repository<CreneauBloc>, prescriptionClient: PrescriptionExterneClient, notificationBackClient: NotificationBackClient, serviceRegistryClient: ServiceRegistryClient, config: ConfigService);

...
export declare class ChecklistPendantOpService {
    ...
    constructor(repo: Repository<ChecklistPendantOp>, accueilClient: AccueilClient, gateway: OperationGateway, patientBlocStatutService: PatientBlocStatutService, tracabiliteService: TracabiliteService);
    ...
    update(id: string, dto: UpdateChecklistPendantOpDto, centralUser?: CentralUser): Promise<ChecklistPendantOp>;
}

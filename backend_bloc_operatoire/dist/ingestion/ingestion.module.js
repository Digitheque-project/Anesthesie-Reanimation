...
const ingestion_ledger_service_1 = require("./ingestion-ledger.service");
...
exports.IngestionModule = IngestionModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([ingestion_externe_entity_1.IngestionExterne])],
        providers: [ingestion_ledger_service_1.IngestionLedgerService],
        exports: [ingestion_ledger_service_1.IngestionLedgerService],
    })
], IngestionModule);
